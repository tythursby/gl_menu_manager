<template>
  <component :is="tag" :class="className">
    <carousel-navigation v-if="showControls" top :testimonial="testimonial" :leftIcon="leftIcon" :rightIcon="rightIcon" :floating="floating" :navClass="navClass" @changeSlide="handleChangeSlide"></carousel-navigation>
