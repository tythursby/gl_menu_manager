<template>
  <div class="mdb-vue-date">
    <div class="datepickbox">
      <mdb-input type="text" :disabled="disabled" :validation="validation" :customValidation="customValidation" :isValid="isValid" :validFeedback="validFeedback" :invalidFeedback="invalidFeedback" :title="mdbOptions.title" :label="mdbOptions.label" class="mdb-datepicker" readonly="readonly" :placeholder="value || mdbOptions.placeholder" v-model="date.time" :required="required" @keydown.native.enter.stop="showCheck" @click.native="showCheck" @focus.native="showCheck" @change="emitDate" />
    </div>
  ...
  computed: {
    ...
    mdbOptions() { 
      ...
      return {
        ...
        placeholder: this.placeholder || this.option.placeholder || 'Please choose a date',
        buttons: {
          ok: buttons.ok,
          clear: buttons.clear, 
          today: buttons.today
